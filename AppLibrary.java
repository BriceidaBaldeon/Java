        ...
        do {
            ...
            switch (opcion) {
                case 1:
                    ...
                    biblioteca.addUser(new User(userId, userName));
                    break;
                case 2:
                    ...
                    if (tipoItem == 1) {
                        ...
                        Item nuevoLibro = new Book(autor);
                        ...
                        Item nuevoDVD = new DVD(itemId, title, true, director, duracion);
                        biblioteca.items.add(nuevoDVD);
                    ...
                    break;
                case 3:
                    biblioteca.showUsers();
                    break;
                case 4:
                    biblioteca.showItems();
                    break;
                case 5:
                    System.out.print("Ingrese el ID del usuario: ");
